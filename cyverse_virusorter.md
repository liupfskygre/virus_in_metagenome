...
```
cd /home/projects/Wetlands/All_genomes/DDIG_megahit_assemblies
O3C3D3_DDIG_MN_megahit_k51_k121_s10_assembly.contigs.fa
...
```
cd /home/projects/Wetlands/All_genomes/DDIG_megahit_assemblies
O3C3D4_DDIG_MN_megahit_assembly.contigs.fa
sed -e 's/>\(k.*\).*flag.*$/>\1/1' O3C3D4_DDIG_MN_megahit_k51_k121_s10_assembly.contigs.fa >O3C3D4DdigMC.fa
